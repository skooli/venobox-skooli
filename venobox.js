          ...
          var option = $.extend(defaults, options);
            ...
            return this.each(function() {
                  ...
                  obj.click(function(e){
                    ...
                    core = '<div class="vbox-overlay ' + extraCss + '" style="background:'+ overlayColor +'"><div class="vbox-preloader">Loading...</div><div class="vbox-container"><div class="vbox-content"></div></div><div class="vbox-title"></div><div class="vbox-num">0/0</div><div class="vbox-rotate" data-toggle="tooltip" data-placement="left" title="Rotate">R</div><div class="vbox-close" data-toggle="tooltip" data-placement="left" title="Close">X</div><div class="vbox-to-whiteboard" data-toggle="tooltip" data-placement="left" title="Send to whiteboard">W</div><div class="vbox-next">next</div><div class="vbox-prev">prev</div></div>';
                    ...
                    var customFunctions = {
                      ...
                      rotate: function(){
                        var tr = $('.vbox-content img').css("transform"),
                            values, a, b;
                        if(tr != "none"){
                          values = tr.split('(')[1],
                        ...
                        var angle = Math.round( Math.asin(b.toFixed(5))*180/Math.PI );
                        if( a < 0 ) { angle = 180-angle; }
                        $('.vbox-content img').css("transform", "rotate("+(angle+90)+"deg)" );
                      },

                      addToWhiteboard: function(){
                        $("img[src='"+dest+"']").closest('.chat-attachment').find("[data-role=add-to-whiteboard]").click();
                      }

                    }

                    /* -------- ROTATE -------- */
                    $('.vbox-rotate').click(function(){
                      customFunctions.rotate();
                    });

                    /* -------- SEND TO WHITEBOARD -------- */
                    $('.vbox-to-whiteboard').click(function(){
                      customFunctions.addToWhiteboard();
                    });
                    ...
                    $(closeclickclass).click(function(e){
                      ...
                      figliall = '.figlio *';
                      rotate = '.vbox-rotate';
                      toWhiteboard = '.vbox-to-whiteboard';
                      if(!$(e.target).is(evitacontent) && !$(e.target).is(evitanext) && !$(e.target).is(evitaprev)&& !$(e.target).is(figliall) && !$(e.target).is(rotate) && !$(e.target).is(toWhiteboard)){
                        closeVbox();
                      }
                    });
